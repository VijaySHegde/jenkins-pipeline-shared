...
def call(rig,tool)
{
 ...
 def response = sh(script:"""curl -X POST  -H  Accept:application/json -H  Content-Type:application/json  -d '{ \"rigletName\":\"${rig}\", \"toolName\":\"${tool}\"}' http://3.134.156.211:3013/api/riglets/connectorServerDetails -o rigoutput.json""", returnStdout: true)
 println(response)
