...
def giturl=jsonObj.scm.projects.url
def gitbranch=jsonObj.scm.projects.branch
def buildjname=jsonObj.ci.jobs.jobName
def buildjurl=jsonObj.ci.jobs.jobUrl
def buildinsurl=jsonObj.ci.jobs.instanceUrl
def sonarprojname=jsonObj.code_quality.projects.projectName
def sonarproid=jsonObj.code_quality.projects.projectId
def sonarurl=jsonObj.code_quality.projects.instanceUrl
def featureprojname=jsonObj.alm.projects.projectName
def featureteamname=jsonObj.alm.projects.teamName
def featureprojid=jsonObj.alm.projects.projectId
def featureteamid=jsonObj.alm.projects.teamId
