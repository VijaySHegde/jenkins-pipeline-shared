...
String sresponse = sh(script: """curl  -X GET -o/dev/null  -I -u ${username}:${password} '${IP}/rest/api/latest/result/${key}.json?max-result=50&expand=results.result.artifacts&expand=changes.change.files&start-index=0'  """, returnStdout: true)
println("hi")
	println(sresponse) 
